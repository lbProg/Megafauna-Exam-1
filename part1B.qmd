...
The authors performed three MCMC chains, each with 100 000 iterations, a burn-in of 1 000 and a thinning rate of 1. They assessed parameters convergence visually using trace plots, lag autocorrelation of parameters, and the Brooks-Gelman-Rubin (BGR) diagnostics. Model selection was carried out by comparing the WAIC values of the models.

Figures 5.D and 5.H show that there is no correlation between $L_{50}$ and phi for either males or females.
