...
```{r}
#| Distributions of l50 and phi for males and females
...
```{r}
#| Maturity ogives for males and females plotted for their respective 5%, mean and 95% confidence interval l50 and phi parameters
